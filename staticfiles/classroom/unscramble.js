            ...
            if (letterIndex < emptySlots.length) {
                ...
                if (letter) {
                    ...
                    if (letter === expectedLetter) {
                        ...
                        if (errorCount + 1 >= 3) {
                            const wordIndex = Array.from(taskElement.querySelectorAll(".word-container")).indexOf(wordContainer);
                            showWordAndReset(wordContainer);
                            saveUserAnswer(taskId, classroomId, {
                                word_index: wordIndex
                            }, "reset_word");
...
function showWordAndReset(wordContainer) {
    ...
    slots.forEach((slot, index) => {
        ...
        slot.classList.add("bg-success", "bg-opacity-25", "active-slot");
